...
export default function SnapRow({
  ...
  const setupObserver = useCallback(() => {
    ...
    // rootMargin: container-н голын 60%-г "viewport" болгоно
    // → зөвхөн голд байгаа card л 1.0 threshold-д орно
    observerRef.current = new IntersectionObserver(
      (entries) => {
        // Хамгийн их intersectionRatio-той card → active
      ...
      {
        root: el,
        // Container өргөний 20%-г хажуугаас хасна → голын 60% л тоолно
